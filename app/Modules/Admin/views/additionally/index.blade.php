...
--}}
@section('content')
    {!! $constructor::adminH2(__('a.Cache')) !!}
    <div class="row">
        <div class="col-md-6">
            {!! $constructor::adminBlockLink(__('a.db_caches'), __('s.remove'), route('admin.additionally', 'cache=db'), 'confirm-link', 'data-toggle="modal" data-target="#modal-confirm"') !!}
        </div>
        <div class="col-md-6">
            {!! $constructor::adminBlockLink(__('a.view_caches'), __('s.remove'), route('admin.additionally', 'cache=views'), 'confirm-link', 'data-toggle="modal" data-target="#modal-confirm"') !!}
        </div>
        <div class="col-md-6">
            {!! $constructor::adminBlockLink(__('a.route_caches'), __('s.remove'), route('admin.additionally', 'cache=routes'), 'confirm-link', 'data-toggle="modal" data-target="#modal-confirm"') !!}
        </div>
        <div class="col-md-6">
            {!! $constructor::adminBlockLink(__('a.config_caches'), __('s.remove'), route('admin.additionally', 'cache=config'), 'confirm-link', 'data-toggle="modal" data-target="#modal-confirm"') !!}
        </div>
    </div>

    {!! $constructor::adminH2(__('a.Backup'), 'mt-5') !!}
    <div class="row">
        <div class="col">
            {!! $constructor::adminBlockLink(__('a.backup_files_db'), __('a.run'), route('admin.additionally', 'backup=run'), 'confirm-link' . $backupDisabled, 'data-toggle="modal" data-target="#modal-confirm"') !!}
        </div>
    </div>

    {!! $constructor::adminH2(__('a.Commands'), 'mt-5') !!}
