...
class MenuNameController extends AppController
{
    ...
    public function index()
    {
        ...
        return view("admin.{$this->view}.$f", compact('values'));
    }
    ...
    public function create()
    {
        ...
        return view("admin.{$this->view}.{$this->template}");
    }
    ...
    public function edit($id)
    {
        if ((int)$id) {
            ...
            // Потомки в массиве
            $getIdParents = \App\Helpers\Admin\App::getIdParents((int)$id, $this->belongsToTable, "{$this->table}_id");

            $this->setMeta(__("a.$f"));
            return view("admin.{$this->view}.{$this->template}", compact('values', 'getIdParents'));
        }
