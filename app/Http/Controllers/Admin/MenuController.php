...
class MenuController extends AppController
{
    ...
    public function index(Request $request)
    {
        ...
        return view("admin.{$this->view}.$f", compact('menu', 'values', 'current_menu_id', 'menuNameCount'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view("admin.{$this->view}.{$this->template}", compact('current_menu_id', 'values', 'menuName'));
    }
    ...
    public function edit($id)
    {
        if ((int)$id) {
            ...
            $this->setMeta(__("a.$f"));
            return view("admin.{$this->view}.{$this->template}", compact('values', 'getIdParents', 'current_menu_id', 'menuName'));
        }
