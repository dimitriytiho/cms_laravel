...
class CartController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("{$this->view}.index", compact('cartSession', 'noBtnModal'));
    }
    ...
    public function show(Request $request)
    {
        if ($request->ajax()) {
            $cartSession = session()->has('cart') ? session()->get('cart') : [];
            return view("{$this->view}.modal")->with(compact('cartSession'))->render();
        }
    ...
    public function plus(Request $request, $product_id)
    {
        if ((int)$product_id) {
            ...
            if ($request->ajax()) {
                return view("{$this->view}.modal")->with(compact('product', 'cartSession'))->render(); //->with(compact('product'))
            }
    ...
    public function destroy(Request $request, $product_id)
    {
        if ((int)$product_id) {
            ...
            if ($request->ajax()) {
                return view("{$this->view}.modal")->with(compact('product', 'cartSession'))->render();
            }
