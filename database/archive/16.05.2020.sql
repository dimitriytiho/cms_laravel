...
CREATE TABLE `filter_products` (
  ...
  `product_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`id`),
  KEY `filter_products_value_id_foreign` (`value_id`),
  ...
  CONSTRAINT `filter_products_value_id_foreign` FOREIGN KEY (`value_id`) REFERENCES `filter_values` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `filter_values` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `filter_values_filter_group_id_foreign` (`filter_group_id`),
  KEY `filter_values_value_index` (`value`),
  CONSTRAINT `filter_values_filter_group_id_foreign` FOREIGN KEY (`filter_group_id`) REFERENCES `filter_groups` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menu_name_id` int(10) unsigned NOT NULL,
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `menu_menu_name_id_foreign` (`menu_name_id`),
  KEY `menu_title_index` (`title`),
  CONSTRAINT `menu_menu_name_id_foreign` FOREIGN KEY (`menu_name_id`) REFERENCES `menu_name` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'Товар 1','tovar-1','active',100.00,0.00,500,NULL,NULL,'/img/default/no_image.jpg','2020-05-11 09:59:52','2020-05-14 05:13:43');
...
INSERT INTO `users` VALUES (1,'Дмитрий','dimitriyyuliya@gmail.com','+7(111)111-11-11',NULL,3,NULL,'$2y$10$6Hq0lD/S3W1bjhS.alUrNuKV9fSpegU/hByScxhaSg39ekll7zFDa','wonderful',NULL,'127.0.0.1','1','/img/default/no_user.png','IMRy5vOghk0LHcHxzlzGr6CcdG9Ay8TyGifCCwro8UboGpFPYB15piTosgjD','2020-01-22 04:37:34','2020-05-11 07:46:17'),(2,'Редактор','dimitriyyuliya@ya.ru',NULL,NULL,4,NULL,'$2y$10$si/Qpawr1W3vg7WVeL.R6.DJnY/GQZ6vLn9oMaL7qPGBnKIwOQpCq','new',NULL,'127.0.0.1','1','/img/default/no_user.png','5zRuijIQ1vwzAThOKcaNGoUVoW9ePYFuuRXZWNsfNecluiHEnfeU9BX5L96a','2020-05-08 05:46:23','2020-05-09 07:23:03'),(3,'Дмитрий','dimitriyyuliya@yandex.ru',NULL,NULL,1,NULL,'$2y$10$PrR/Ib4xMo/VYvywHVAe.elyNkUA9814mTPiLFr110y8jHqSrf.Za','new',NULL,'127.0.0.1','1','/img/default/no_user.png',NULL,'2020-05-09 06:13:59','2020-05-09 06:13:59');
...
INSERT INTO `users_last_data` VALUES (1,1,3,'Дмитрий','dimitriyyuliya@gmail.com','+7(111)111-11-11',NULL,'wonderful','127.0.0.1','/img/default/no_user.png','2020-05-05 06:48:14','2020-05-05 06:48:14'),(2,2,1,'Дмитрий','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:34:03','2020-05-09 06:34:03'),(3,2,4,'Дмитрий','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:36:27','2020-05-09 06:36:27'),(4,2,3,'Дмитрий','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:37:06','2020-05-09 06:37:06'),(5,2,4,'Дмитрий','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:39:59','2020-05-09 06:39:59'),(6,2,3,'Дмитрий','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:40:13','2020-05-09 06:40:13'),(7,2,4,'Дмитрий','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:40:43','2020-05-09 06:40:43'),(8,2,4,'Редактор','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:57:02','2020-05-09 06:57:02'),(9,2,3,'Редактор','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 06:57:06','2020-05-09 06:57:06'),(10,2,4,'Редактор','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 07:22:58','2020-05-09 07:22:58'),(11,2,3,'Редактор','dimitriyyuliya@ya.ru',NULL,NULL,'new','127.0.0.1','/img/default/no_user.png','2020-05-09 07:23:03','2020-05-09 07:23:03'),(12,1,3,'Дмитрий','dimitriyyuliya@gmail.com','+7(111)111-11-12',NULL,'wonderful','127.0.0.1','/img/default/no_user.png','2020-05-11 07:46:17','2020-05-11 07:46:17');
...
-- Dump completed on 2020-05-16 11:42:16
