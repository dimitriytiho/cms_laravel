    ...
    <div class="row">
        ...
        <div class="col bg-primary d-flex justify-content-between shadow py-1 a-white header__left">
            ...
            <ul class="nav justify-content-end header__right">
                ...
                <li class="nav-item d-flex align-items-center">
                    <a href="{{ route('admin.locale', $excludeCurrentLocale[0] ?? null) }}" class="nav-link d-flex align-items-center">{{ !empty($excludeCurrentLocale[0]) ? Str::ucfirst($excludeCurrentLocale[0]) : null }}</a>
                </li>
