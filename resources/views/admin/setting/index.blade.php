                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            {{--<th scope="col" class="font-weight-light">{{ __('f.type') }}</th>--}}
                            <th scope="col" class="font-weight-light">{{ __('f.value') }}</th>
                        </tr>
                        </thead>
                        <tbody>
                        @foreach ($values as $v)
        ...
        <div class="row">
            <div class="col">
                <div class="border text-secondary rounded my-4 p-4">
                    <span class="font-weight-light">{{ __('a.example_use_in_views') }}</span>
