...
<head>
    ...
    @yield('css')
    <link rel="stylesheet" type="text/css" href="{{ asset('css/add.css') }}" media="all">
</head>
<body>
{{--
...
<script>
    var body = document.querySelector('body'),
        ...
        site_email = '{{ \App\App::$registry->get('settings')['site_email'] ?? ' ' }}',
...
@if(!empty(\App\App::$registry->get('scripts')))
    @foreach(\App\App::$registry->get('scripts') as $script)
        {!! $script . PHP_EOL !!}
    @endforeach
@endif
